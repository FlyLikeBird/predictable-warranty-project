...
let menuData = [
  {
    menu_code: 'global_monitor',
    menu_name: '监控中心',
    menu_id: 1,
    child: [{ menu_code: 'data_board', menu_name: '数据看板', menu_id: 2 }],
  },
  {
  ...
  },
  {
    ...
    child: [
      {
        menu_code: 'operation_manage_order',
        menu_name: '工单中心',
        menu_id: 15,
      },
      {
        menu_code: 'operation_manage_analysis',
        menu_name: '工单分析',
        menu_id: 155,
      },
      {
        menu_code: 'operation_manage_maintain',
        menu_name: '保养计划',
        menu_id: 14,
      },
    ],
          ...
          if (localStorage.getItem('userId')) {
            ...
            if (companyId) {
              socket = createWebSocket(
                `wss://${config.socketHost}:${config.socketPort}/websocket/${companyId}`,
