...
import { Form, Input, InputNumber, DatePicker, Cascader, Button, Select, Switch, Modal, message } from 'antd';
...
function UserForm({ info, companyList, roleList, onClose, onDispatch }){
    ...
    useEffect(()=>{
        if ( info.forEdit ) {
            let { userName, realName, phone, email, companyId, roleId, isActived, invalidTime, province, city, area } = info.current;
            form.setFieldsValue({
                userName,
                realName,
                phone,
