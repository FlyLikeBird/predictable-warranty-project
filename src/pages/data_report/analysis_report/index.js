        ...
        <div className={style['report-container']}>
            ...
            <div style={{ width:'100%'}} ref={containerRef}>
                ...
                <div className={style['page-container']}>
                    <div style={{ height:'100%', backgroundImage:`url(${reportBg})`, backgroundRepeat:'no-repeat', backgroundSize:'cover' }}>
                    </div>
                    
                    <div style={{ position:'absolute', left:'50%', fontSize:'2.4rem', transform:'translateX(-50%)', color:'#155cff', whiteSpace:'nowrap', top:'420px' }}>
                        <div>{`${startDate.year()}年${startDate.month() + 1}月分析报告`}</div>
                    </div>
...
export default connect(({ user })=>({ user }))(AnalyzeReport);