...
function MachDetailManager({
  ...
  const infoList = [
    ...
    {
      label: '电池状态',
      value: +currentMach.batteryStatus === 1 ? '电量低' : '正常',
      hasIcon: true,
    },
  ...
  let ImgCom = imgPath ? (
    <div style={{ height: '100%', textAlign: 'center' }}>
      <img src={imgPath} style={{ height: '70%' }} />
    </div>
  ) : (
    <div style={{ textAlign: 'center' }}>
      <FileImageFilled
        style={{ color: '#c9c9c9', fontSize: '4rem', margin: '0.5rem 0' }}
      />
      <div>还没有配置设备图</div>
    </div>
  );
    ...
    <>
      <div style={{ height: '40px' }}>
        ...
        <Select
          ...
          value={currentMach.equipmentCode}
          onChange={(value) => {
      ...
      <div style={{ height: 'calc( 100% - 40px)' }}>
        ...
        <div
          ...
          style={{ width: '24%', paddingBottom: '0' }}
        >
          <div
            className={style['card-container']}
            style={{ padding: '1rem', overflow: 'hidden', boxShadow: 'none' }}
          >
