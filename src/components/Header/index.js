...
import { createFromIconfontCN, AlertOutlined, FullscreenOutlined, FullscreenExitOutlined, HomeOutlined  } from '@ant-design/icons';
                    ...
                    <div className={style['weather-container']}>
                        {
                            isFulled
                            ?
                            <FullscreenExitOutlined style={{ fontSize:'1.2rem', margin:'0 10px' }} onClick={()=>{
                                cancelFullScreen();
                            }} />
                            :
                            <FullscreenOutlined style={{ fontSize:'1.2rem', margin:'0 10px' }} onClick={()=>{
...
function areEqual(prevProps, nextProps){
    if ( prevProps.routePath !== nextProps.routePath ||  prevProps.msg !== nextProps.msg  ||  prevProps.theme !== nextProps.theme ) {
        return false;
    } else {
        return true;
    }
